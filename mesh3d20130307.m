...
ans=bound/h;
%dol1
% [x,y,z]=meshgrid(-box(2,1):box(2,1)*0.1:box(2,1));
%sphere
...
%滤波2
%dol1
% [xi,yi,zi]=meshgrid(-box(2,1):box(2,1)*0.07:box(2,1));
%sphere
...
r0=max(r0)+min(r0)-r0;
% r0=r0/max(r0);
% p=[fix; p(rand(size(p,1),1)<(min(r0)+0.01)^dim./r0.^dim,1:3)];   %概率选点
